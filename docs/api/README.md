...
- [NeDictMeaning](interfaces/NeDictMeaning.md)
...
- [DictNames](type-aliases/DictNames.md)
...
- [convertJMnedict](functions/convertJMnedict.md)
...
- [hiraganaToKatakana](functions/hiraganaToKatakana.md)
...
- [katakanaToHiragana](functions/katakanaToHiragana.md)
